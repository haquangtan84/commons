...
function UIDSUpload() {
	...
	UIDSUpload.prototype.getStyleSheetContent = function(){
	  ...
	  styleText += "    background: url('/eXoSkin/skin/less/commons/skin/DocumentSelector/images/fileShareUpload.png') no-repeat 3px center;}";
	  ...
	  styleText += "    background: url('/eXoSkin/skin/less/commons/skin/DocumentSelector/images/fileShareUploadBlue.png') no-repeat 3px center;}";
	  return styleText;
	}
